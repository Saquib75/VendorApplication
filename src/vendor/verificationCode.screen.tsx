        ...
        <View style={styles.customContainer}>
          ...
          <View style={{alignItems: 'center'}}>
            ...
            <TouchableOpacity
              ...
              onPress={() => navigation.navigate(VENDOR_ROUTES.ResetPassword)}
              activeOpacity={0.8}>
...
export default VendorVerificationCode;
